...
public class PaginaTarefas extends JFrame implements WindowListener {

	private static final long serialVersionUID = -5235226375095718632L;

	public static Tarefa[] listaSelecionada;
...
////////////////////<< CRIAÇÃO DA INTERFACE GRÁFICA >>> /////////////////////////////
	...
	public PaginaTarefas() {
		...
		panel_adicionarTarefa.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"ADICIONAR TAREFA", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		comboBox_urgencia.setModel(
				new DefaultComboBoxModel(new String[] { "", "Urgente", "Importante", "Quando Possível", "Rotina" }));
		...
		comboBox_tempo.setModel(new DefaultComboBoxModel<Object>(
		new String[] { "", "Até 30 min", "1 hora", "Entre 1 e 3 horas", "Entre 3 e 5 horas" }));
...
//////////////////// << LÓGICA >>> /////////////////////////////
		...
		// FAZER JANELA APARECER NO MEIO DA TELA
		this.setLocationRelativeTo(null);

		// INSTANCIANDO ALGUMAS TAREFAS
		Tarefa t1 = new Tarefa("Arrumar Quarto", "Organizar guarda-roupa", "Urgente", "Fácil", "1 hora");
		Tarefa t2 = new Tarefa("Academia", "Ir 4 vezes na semana", "Rotina", "Fácil", "1 hora");
		Tarefa t3 = new Tarefa("Cozinhar", "Fazer marmitas para a semana", "Rotina", "Fácil", "Entre 1 e 3 horas");
		Tarefa t4 = new Tarefa("Atualizar LinkedIn", "Incluir cursos e certificados", "Quando Possível", "Médio",
				"1 hora");
		Tarefa t5 = new Tarefa("Terminar A3", "Concluir gerenciador de tarefas", "Urgente", "Médio",
				"Entre 3 e 5 horas");
		Tarefa t6 = new Tarefa("Estudar SQL", "Curso do Gustavo Guanabara", "Importante", "Fácil", "Entre 3 e 5 horas");

		// INSTANCIANDO O ARRAY DE TAREFAS
		...
		btnAdicionar.addActionListener(evt -> {
			...
			if (input_nomeTarefa.getText() != null) {
				novaTarefa.adicionarNalista(listaSelecionada);
				list_listaTarefas.setListData(listaSelecionada);
				// Limpar Campos
				...
				JOptionPane.showMessageDialog(null, "Nova tarefa cadastrada com sucesso!", "SALVAR", JOptionPane.DEFAULT_OPTION);
			} else {
				JOptionPane.showMessageDialog(show_descricao, "Escolha uma Categoria!");
			}
			
		});
		// FIM - BOTAO ADICIONAR TAREFA

		
		// INICIO - MOSTRAR DETALHES AO SELECIONAR TAREFA
		...
		// FIM - MOSTRAR DETALHES AO SELECIONAR TAREFA
		...
		btnMarcarConcluido.addActionListener(evt -> {
			...
			int indexSelecionado = list_listaTarefas.getSelectedIndex();
			listaSelecionada = Tarefa.marcarComoConcluido(listaSelecionada, indexSelecionado);
			list_listaTarefas.setListData(listaSelecionada);
		});
